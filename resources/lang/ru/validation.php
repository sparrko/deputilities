...
return [
    'attributes' => [
        ...
        'bik' => '"БИК"',
        'bank_name' => '"Название"',
        'bank_num' => '"Расчетный счет"',
        'bank_cor' => 'Корреспондентский счет"',
        'desc' => '"Описание компании на главной странице"',
    ...
    'unique'               => 'Такое значение поля :attribute уже существует в БД.',
